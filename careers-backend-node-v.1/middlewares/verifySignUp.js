...
const sendNotificationMail = (email, subject, message) => {
  return new Promise((resolve, reject) => {
    const mailOptions = {
      ...
      html: `<p>${message}</p>`, // Corrected the message interpolation
    };
...
const checkRolesExisted = (req, res, next) => {
  const ROLES = ["admin", "user", "guest"]; // Example of predefined roles. Replace it with your actual roles if necessary.
